...
const StockDataChart = () => {
        ...
        datasets: [
            {
                label: 'Latest Prices',
                data: latestPrices,
                backgroundColor: 'rgba(85, 190, 192, 0.6)',
    ...
    return (
        <div>
            <div style={{ backgroundColor: '#1890ff', padding: '20px 0', textAlign: 'center', marginBottom: '21px' }}>
                <h2 style={{ color: 'white' }}>Bar Chart : Company Prices</h2>
            </div>
            <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', minHeight: '60vh', margin: '21px' }}>
