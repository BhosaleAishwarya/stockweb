        ...
        datasets: [
            {
                label: 'Latest Prices',
                data: latestPrices,
                backgroundColor: 'rgba(75, 190, 191, 0.6)',
                borderColor: 'rgba(75, 190, 193, 1)',
                borderWidth: 1,
            },
            {
                label: 'Highest Prices',
                data: highestPrices,
                backgroundColor: 'rgba(265, 99, 132, 0.6)',
                borderColor: 'rgba(258, 99, 130, 1)',
                borderWidth: 1,
            },
        ],
    };
    ...
    return (
        <div>
            <div style={{ backgroundColor: '#1890ff', padding: '20px 0', textAlign: 'center', marginBottom: '20px' }}>
                <h2 style={{ color: 'white' }}>Bar Chart : Favorite Stocks</h2>
            </div>
