  ...
  return (
    <div>
      <div style={{ backgroundColor: '#1890ff', padding: '20px 0' }}>
        <Title style={{ color: 'white', textAlign: 'center' }}>Welcome to Stock Market Dashboard!</Title>
      </div>
            ...
            <Typography>
             {/* / <Title className="title">Welcome to the Stock Market Dashboard!</Title> */}
              <Paragraph className="paragraph">
                The Stock Market Dashboard is platform designed to provide users with real-time
                stock market data and powerful analysis.
              </Paragraph>
